-- SQLite
--TAREFA 8- Construa uma query SQL para criar a tabela LOCATIONS (Locações) 
--no banco de dados, e logo em seguida insira as locações 
...
CREATE TABLE LOCATIONS (
    ...
    FOREIGN KEY (EMPLOYEE_ID) REFERENCES EMPLOYEERS (ID)
);

INSERT INTO LOCATIONS (ID, START_DATE, END_DATE, TOTAL, CUSTOMER_ID, CAR_ID, EMPLOYEE_ID)
VALUES (1,'2021-04-01','2021-04-07',1500,1,1,2),
